...
export default function ReviewsStats() {
    ...
    return (
        <div className='page-container'>                    
            ...
            {Stats && Boolean(Stats.num_total_reviews) && Boolean(Stats.user_num_reviews) ?
                <div>
                <div className='reviews_statistics-container' style={{marginTop: 180, marginBottom: 270}}>
                <div className='reviews_statistics-column'>
                <div className='reviews_statistics-row'>
                    <h1 className='title-in-line' style={{marginBottom: 10}}>General Statistics</h1>
                    <ul>
                        <li>
                            <p style={{marginTop: 20}}>
                                In total, <b>{Stats.num_total_reviews}</b> reviews have been posted by&nbsp;
                                <b>{Stats.num_total_users}</b> different users, meaning that, on average,&nbsp;
                                each user has posted <b>{divide(Stats.num_total_reviews, Stats.num_total_users)}</b>&nbsp;
                                reviews. You have posted <b>{Stats.user_num_reviews}</b> reviews.
                            </p>
                        </li>
                        <li>
                            <p style={{marginTop: 20}}>
                                The average user rating is <b>{Stats.average_stars}</b>&nbsp;
                                out of 5. Your average rating  in your reviews is <b>{Stats.user_avg_stars}</b> out of 5.
                            </p>
                        </li>
                    </ul>
                    </div></div>
                </div>
                <h1 style={{marginLeft: 200, marginTop: 350, marginBottom: 100}}>
                        Now, let's take a closer look at the reviews you have posted:
                </h1>
                <div className='reviews_statistics-container'>
                    <div className='reviews_statistics-column'>
                        <div className='reviews_statistics-row'>
                            <h1 className='title-in-line' style={{marginBottom: 10}}>Your Highest Rated Titles</h1>
                            <table>
                                <tr>
                                    <th>Stars</th>
                ...
                <div className='reviews_statistics-container'>
                    <div className='reviews_statistics-column'>
                        <div className='reviews_statistics-row'>
                            <h1 className='title-in-line' style={{marginBottom: 10}}>Your Lowest Rated Titles</h1>
                            <table>
                                <tr>
                                    <th>Stars</th>
                                    <th>Original Title</th>
